...
tar -zxvf CentOS_ARM64.tar.gz -C ./CentOS
sudo chroot ./CentOS /bin/bash -x <<'EOF'
su -
...
tar -czvf ../CentOS_BaseImage.tar.gz .
popd > /dev/null

#Clear unused files
rm -fr ./CentOS
rm -fr ./CentOS_ARM64.tar.gz
...
docker build -t openestuary/centos${tag} .
