...
my $socket  = '/u01/my3306/run/mysql.sock';
my $version = '5.6.22-72.0';
...
my $ldata   = '/u01/my3306/data';
my $execdir = '/u01/my3306/bin';
my $bindir  = '/u01/my3306/bin';

# ----------------------------------------------------------------------
# If installed, search for the compiled in directory first (might be "lib64")
# ----------------------------------------------------------------------

my $pkglibdir = fix_path('/u01/my3306/lib',"libmysql/relwithdebinfo",
                         "libmysql/release","libmysql/debug","lib/mysql","lib");

my $pkgincludedir = fix_path('/u01/my3306/include', "include/mysql", "include");
...
$flags->{cflags}  = [@{$flags->{include}},split(" ",'  -O2 -fabi-version=2 -fno-omit-frame-pointer -fno-strict-aliasing -DDBUG_OFF')];
$flags->{cxxflags}= [@{$flags->{include}},split(" ",'  -O2 -fabi-version=2 -fno-omit-frame-pointer -fno-strict-aliasing -DDBUG_OFF')];
